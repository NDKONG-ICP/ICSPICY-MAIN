...
import {
  buildFallbackGuide as buildFallbackGuideCore,
} from "./variety-guide-fallback.mjs";
import {
  chatErrorToString,
  getSpicyAiActor,
  toSpicyAiMessage,
...
// ── Fallback (shared module — also used by build-time prerender) ─────────────
...
export function buildFallbackGuide(
  ...
  return buildFallbackGuideCore(variety, conditions, recipes) as GeneratedGuide;
}
