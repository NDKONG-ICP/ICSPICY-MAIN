...
const STEPS = [
  { title: "Welcome to IC SPICY Garden Designer! 🌶️", body: "Design your dream garden with 385 Florida plants.", target: null },
  { title: "Try AI Design", body: "Type what you want and let on-chain SpicyAI lay out your garden.", target: "[data-tour=ai-bar]" },
  { title: "Browse the Catalog", body: "Drag plants and structures onto your plot from the sidebar.", target: "[data-tour=catalog]" },
  { title: "Walk Through Your Garden", body: "Experience your design in first-person 3D with ambient sound.", target: "[data-tour=walk]" },
  { title: "Save & Share", body: "Designs save on the Internet Computer. Share with the community gallery.", target: "[data-tour=save]" },
];
  ...
  return (
    <div className="fixed inset-0 z-[100] pointer-events-none">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-[min(420px,92vw)] rounded-xl border border-white/10 bg-card p-4 shadow-2xl pointer-events-auto">
        <p className="text-xs text-primary mb-1">Step {step + 1} of {STEPS.length}</p>
        ...
        <div className="flex gap-2 justify-end">
          ...
          {step < STEPS.length - 1 ? (
            ...
            <Button size="sm" onClick={finish}>Start Designing!</Button>
          )}
        </div>
      </div>
    </div>
