// migrations/PhaseAgentHubAmbassadors.mo
// One-time upgrade: add #ambassador_crumbeatr / #ambassador_swop / #ambassador_bonsai
// to AgentKind in persisted agent/job/draft maps (Captain Capsaicin cross-dapp agent).
