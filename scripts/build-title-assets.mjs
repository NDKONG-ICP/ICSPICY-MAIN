...
const SRC = path.join(ROOT, "art-src/games/titles");
const OUT = path.join(ROOT, "src/frontend/public/games/titles");

const TARGETS = {
  "title-slicer": { quality: 72, maxWidth: 1080 },
  "title-pepper-patch": { quality: 72, maxWidth: 1080 },
  "title-crafter": { quality: 72, maxWidth: 1080 },
};
